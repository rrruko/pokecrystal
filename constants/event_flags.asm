...
; Youngster
	...
	const EVENT_BEAT_LORD_MYOTISMON
; Teacher
...
; Johto items: 0x640
	...
	const EVENT_DOG_POKEBALL_IN_ELMS_LAB
	...
	const EVENT_ROUTE_29_GS_BALL
	const EVENT_ROUTE_29_MASTER_BALL
